    ...
    <AdminLayout user={user} onLogout={handleLogout}>
      <div className="max-w-3xl mx-auto space-y-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Create a new product bundle</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-5">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="md:col-span-2">
              ...
              <input type="text" value={image} onChange={(e) => setImage(e.target.value)} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gold focus:border-gold outline-none text-sm" placeholder="/images/products/bundle_7.jpg" />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="max-h-64 overflow-y-auto border border-gray-200 rounded-lg divide-y divide-gray-100">
              ...
              {products.length === 0 && <p className="px-4 py-3 text-sm text-gray-400">No products available</p>}
            </div>
          </div>
